			...
			<div
             ...
             h-72 lg:h-[22rem]  relative flex flex-col ">
				<div
					...
					lg:w-40 lg:h-40 flex justify-center items-center">
				...
				<div
					...
					className="absolute -top-16 md:-top-16 left-[50%] -translate-x-[50%] lg:-top-24  cursor-pointer bg-gradient-to-b from-ScissorsGradient to-ScissorsGradientTo rounded-full w-32 h-32 lg:w-40 lg:h-40 flex justify-center items-center">
					<div className="bg-gray-200 rounded-full w-[80%] h-[80%]  flex justify-center items-center ">
				...
				<div
					...
					className="absolute -bottom-10 right-[10%]   lg:-bottom-10 lg:right-10 cursor-pointer bg-gradient-to-b from-RockGradient to-RockGradientTo rounded-full w-32 h-32 lg:w-40 lg:h-40 flex justify-center items-center">
					<div className="bg-gray-200 rounded-full w-[80%] h-[80%]  flex justify-center items-center">
				...
				<div
					...
					className="absolute -bottom-10 left-[10%]  lg:-bottom-10 lg:left-10 cursor-pointer bg-gradient-to-b from-LizardGradient to-LizardGradientTo rounded-full w-32 h-32 lg:w-40 lg:h-40 flex justify-center items-center self-center">
					<div className="bg-gray-200 rounded-full w-[80%] h-[80%]  flex justify-center items-center">
				...
				<div
					...
					className="absolute -left-2 md:left-5 top-[15%] md:top-[10%] lg:-left-12 cursor-pointer bg-gradient-to-b from-Cyan to-CyanTo rounded-full w-32 h-32 lg:w-40 lg:h-40 flex justify-center items-center self-center">
					<div className="bg-gray-200 rounded-full w-[80%] h-[80%]  flex justify-center items-center">
